    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Gerencie as contas a pagar da sua empresa</p>
        </div>
        <button
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl px-6 py-4 mb-6 flex items-center justify-between">
        <div>
          <p className="text-sm text-blue-600 font-medium">Total de despesas cadastradas</p>
          <p className="text-xs text-blue-400 mt-0.5">Usado no rateio da precificação</p>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="text-left text-xs font-medium text-gray-500 px-6 py-3">Valor</th>
                <th className="text-left text-xs font-medium text-gray-500 px-6 py-3">Vencimento</th>
                <th className="text-left text-xs font-medium text-gray-500 px-6 py-3">Pagamento</th>
            ...
            <tbody>
              {contas.map((conta, index) => (
                ...
                >
                  <td className="px-6 py-4 text-sm font-medium text-gray-800">{conta.descricao}</td>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-6">
            ...
            <div className="flex gap-3 mt-6">
              ...
              >
                {contaEditando ? 'Salvar alterações' : 'Criar despesa'}
              </button>
            </div>
